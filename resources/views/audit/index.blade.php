...
@section('content')
                ...
                <div class="card mb-4 ">
                    <div class="card-header">
                        <div class="w-100 w-md-auto mb-2 mb-md-0">
                            <h4 class="mb-0">List Audit Dokumen</h4>
                    ...
                    <div class="card-body p-4">
                        <div class="w-100">
                            <div class="d-flex flex-column flex-md-row justify-content-between mb-4">
                                <button class="btn btn-primary w-lg-auto mb-3 mb-md-0" onclick="openModal('uploadModal')">
                                    Upload Audit Dokumen
                                </button>
                                <div class="w-100 w-md-25 ms-md-3">
                                    <input type="text" id="search" data-route="{{ route('audit.search') }}"
                                        name="search" placeholder="Search Audit Dokumen" autocomplete="off"
                                        class="form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="uploadModal"
                            ...
                            <div class="bg-white w-full max-w-md p-6 rounded-lg shadow-lg">
                                ...
                                <div class="flex justify-between items-center border-b pb-2">
                                    <h2 class="text-lg font-semibold">Upload Audit Dokumen</h2>
                        ...
                        <div class="space-y-4" id="auditList">
                            @include('audit.auditList', ['data' => $data])
                        </div>
    ...
    <script>
        $(document).ready(function() {
            let timer = null;
            let originalContent = $('#auditList').html();
            ...
            $('#search').on('input', function() {
                ...
                timer = setTimeout(() => {
                    if (query === '') {
                        $('#auditList').html(originalContent);
                    } else {
                        performSearch(query);
                    }
                }, 300);
